...
//             ' мультиплікаційного серіалу Сімпсони. Барт — найстарша дитина Гомера і Мардж Сімпсон. У нього також є дві молодші сестри — Ліса і Меґґі. Барт є втіленням образу бешкетника та посереднього учня у школі. Разом зі своїм батьком Барт є одним із найвідоміших персонажів у цьому серіалі.',
...
//
//
//     divMember.appendChild(h2);
//     divMember.appendChild(img)
//     divMember.appendChild(p)
...
//     let block = document.createElement('course');
//     let title = document.createElement('h2');
//     title.innerText = `${course.title}`;
//
//     let monthDurationElement = document.createElement('div');
//     monthDurationElement.innerText = `Duration ${course.monthDuration} months`
//     let hourDurationElement = document.createElement('div');
//     hourDurationElement.innerText = `Duration ${course.hourDuration} hours`
//
//     let modulesElement = document.createElement('ul');
//
//     for (const modulesItem of course.modules) {
//         let module = document.createElement('li');
//         module.innerText = modulesItem;
//         modulesElement.appendChild(module)
//     }
//
//     block.appendChild(title);
//     block.append(monthDurationElement,hourDurationElement);
//     block.appendChild(modulesElement)
